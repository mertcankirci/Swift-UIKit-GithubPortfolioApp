...
class SearchVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        createDismissKeyboardTapGestre()
    ...
    func createDismissKeyboardTapGestre() {
    ...
    func configureLogoImageView() {
        ...
        let topConstarintConstant: CGFloat = DeviceType.isiPhoneSE || DeviceType.isiPhone8Zoomed ? 20 : 80
